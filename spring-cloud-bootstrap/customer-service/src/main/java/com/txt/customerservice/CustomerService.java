...
import com.txt.orderservice.client.OrderClient;
import com.txt.orderservice.client.OrderDTO;
import com.txt.orderservice.client.OrderResponse;
...
public class CustomerService {
    ...
    public String sendOrder(@RequestBody Map<String, Object> body) {
        ...
        dto.setCustomerId(Integer.parseInt(body.get("customerId").toString()));
